...
MIDDLEWARE = [
    ...
    'Vetrina_App.middleware.AuthenticationMiddleware',
]

ROOT_URLCONF = 'Vetrina_Project.urls'
...
WSGI_APPLICATION = 'Vetrina_Project.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'pr@tdtl.world'
EMAIL_HOST_PASSWORD = 'Office#0209'
DEFAULT_FROM_EMAIL = 'pr@tdtl.world'
